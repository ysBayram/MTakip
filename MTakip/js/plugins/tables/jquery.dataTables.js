...
(function($, window, document) {
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			 ...
			 */
			this.oLanguage = {
				"sProcessing": "Uygulaniyor...",
				"sLengthMenu": "<span class='itemsPerPage'>Sayfa basi gosterim miktari:</span> <span style='font-size: 11px;'>_MENU_</span>",
				"sZeroRecords": "Herhangi bir kayýt bulunamadý",
				"sEmptyTable": "Tabloda uygun data bulunamadý",
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			sSearchStr = (sSearchStr.indexOf('_INPUT_') !== -1) ?
			  ...
			  sSearchStr==="" ? '<input type="text" />' : sSearchStr+' <input type="text" placeholder="Aranacak veriyi giriniz..." /><div class="srch"></div>';
